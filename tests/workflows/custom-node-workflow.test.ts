...
`;
  ...
  describe('Project-authored code compilation', () => {
    it('should compile a typical custom pattern node', async () => {
      // This simulates code authored directly in a Cascade project.
      const aiGeneratedCode = `
// Checkerboard Pattern Generator
// Project-owned code for creating a procedural checkerboard pattern
...
`;
    ...
    it('should compile a custom data-processing node', async () => {
      const aiGeneratedCode = `
// JSON Parser Node
